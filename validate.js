 ...
 * ввод нужно поправить) и warnings (расчёт возможен, но случай нетиповой —
 * например, E14 вне рекомендованного диапазона 32–38 °C).
 *
...
(function (root) {
  ...
  function validate(s) {
    ...
    if (!bad.e14 && (s.e14 < 32 || s.e14 > 38)) {
      warnings.push({ field: 'e14', message: 'Т после II ступени вне типового диапазона 32–38 °C — расчёт продолжится, но случай нетиповой' });
    }
